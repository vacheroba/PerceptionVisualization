...
model.compile(optimizer='adam',
              loss=utils.rgb_ssim_loss,  # "binary_crossentropy",
              metrics=[utils.rgb_ssim_loss, utils.euclidean_distance_loss])
...
modelpath = os.path.join(basepath, "../models/decoder_ssim")
